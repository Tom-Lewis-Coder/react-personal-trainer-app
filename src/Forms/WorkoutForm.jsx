    ...
    return (
        <>
            <form className='workout-form' >
                <div className='workout-form-title'>Choose Difficulty</div><br />
                <input
                    id='low'
                    type='radio'
                    name='radio'
                ...
                /><label className='app__workoutRadio' htmlFor='low' >Low</label>
                <input
                    id='medium'
                    type='radio'
                    name='radio'
                    value='medium'
                    onChange={getDifficulty}
                /><label className='app__workoutRadio' htmlFor='medium' >Med</label>
                <input
                    id='high'
                    type='radio'
                    name='radio'
            ...
            <div className="workout-box">
                <div className="exercise" >{workout.map(ex => <div key={uuidv4()} className='ex'>{ex}</div>)}</div>
            </div>
        </>
    )
}
