        ...
        <>
            <form>
                <div className="app__calCalc-1">
                    ...
                    >
                        <option value="1">
                            BMR (Basal Metabolic Rate) No activity
                        </option>
                        <option value="1.2">
                            Sedentary: little to no activity
                        </option>
                        <option value="1.375">
                            Light: exercise 1/3 x per week
                        </option>
                        <option value="1.465">
                            Moderate: exercise 4/5 x per week
                        </option>
                        <option value="1.55">
                            Active: daily exercise or intense 3/4 x per week
                        </option>
                        <option value="1.725">
                            Very: intense exercise 6/7 x per week
                        </option>
                        <option value="1.9">
                            Extremely: intense exercise/job daily
                        </option>
                    </select>
                </div>
                <Button
