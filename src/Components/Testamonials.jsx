...
const Testamonials = ({ name, content, stars }) => {
  let fullStars = [
    <ImStarFull key={1} size={20} />,
    <ImStarFull key={2} size={20} />,
    <ImStarFull key={3} size={20} />,
    <ImStarFull key={4} size={20} />,
    <ImStarFull key={5} size={20} />
  ]
  let starsArr =
    stars % 1 === 0.5
  ...
  return (
    <div className="app__testamonial-component">
      ...
      <div data-testid="starsArr" className="app__reviews-stars">
        {starsArr}
      </div>
    </div>
  )
