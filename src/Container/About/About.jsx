        ...
        <div className='app__about app__flex' id='about'>
            ...
            <div className='app__about-split-container '>
                <div className='app__about-box'>
                    ...
                    <Link to='./fatloss' className='app__about-link'>Learn More</Link>
                </div>
                <div className='app__about-box'>
                    <img className='app__about-image-1' alt='' />
                    <p className='app__about-caption'><span>Health and Wellbeing</span><br /><br />Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                    <Link to='./healthandwellbeing' className='app__about-link'>Learn More</Link>
                </div>
                <div className='app__about-box'>
                    ...
                    <Link to='./musclebuilding' className='app__about-link'>Learn More</Link>
                </div>
            </div>
        </div>
    )
