        ...
        <div className="app__fitForm">
            ...
            <form className="app__fitform-form">
                ...
                >
                    ...
                    <option value={15}>
                        Fairly balanced with some indulgences
                    </option>
                ...
                <label>
                    Are you confident you could run 1 mile uninterupted?
                </label>
                <select
                    name="q10"
                    onChange={handleFitFormChange}
                ...
                <label>
                    Do you have any chronic illness or pain? ie a condition that
                ...
                <div className="app__fitform-result-display">
                    <p>
                        {fitFormResult
                            ? `You scored ${fitFormResult} : ${caption}`
                            : ''}
                    </p>
                    {fitFormResult ? (
