  ...
  return (
    <div className='app__fitForm'>
      ...
      <form className='app__fitform-form'>
        ...
        <select name="q10" onChange={handleFitFormChange} value={q10} className='app__fitform-input'>
          <option value={0}>Select one...</option>
          <option value={20}>Yes comfortably</option>
        ...
        <select name="q11" onChange={handleFitFormChange} value={q11} className='app__fitform-input'>
          <option value={0}>Select one...</option>
          <option value={20}>Yes comfortably</option>
          <option value={15}>Just about</option>
        ...
        <label>Do you have any chronic illness or pain? ie a condition that has been present for over 1 year</label>
        <select name="q12" onChange={handleFitFormChange} value={q12} className='app__fitform-input'>
          <option value={0}>Select one...</option>
          <option value={20}>No</option>
          <option value={3}>Yes</option>
        </select>
        <Button title={'Submit'} onClick={handleFitFormSubmit} className={'app__fitform-submit-button'} />
        <div className="app__fitform-result-display">
          <p>{fitFormResult ? `You scored ${fitFormResult} : ${caption}` : ''}</p>
          {fitFormResult ? <HashLink smooth to="/#getInTouch"><button className='app__fitform-getintouch-button'>Get in Touch</button></HashLink> : ''}
        </div>
      </form>
    </div>
  )
